<html>
  ...
  <body>
    <main class="wrapper">
      ...
      <p><a href="buy-shopping-cart.jsp">Go to Cart Checkout Here</a></p>
      <div class="wrapper">
  	    <h1> Home Page </h1>
  	    <div class="pagelinks">
          <%
          ...
          <ul>
            ...
            <li><a href="<%=categoryLink%>">Edit Categories</a></li>
            <li><a href="<%=productLink%>">Edit Products</a></li>
            <li><a href="products-browsing.jsp">Browse Products</a></li>
          </ul>
	    </div>
	  </div>
    </main>
